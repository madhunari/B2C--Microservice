...
import com.seller.Seller.filter.JwtAuthFilter;
...
public class SecurityConfig {
	...
	@Bean public SecurityFilterChain securityFilterChain(HttpSecurity http)
	  ...
	  .requestMatchers("/api/user/admin/register","/api/user/delete/seller",
	  "/api/order/fetch/all", "/api/category/update", "/api/category/add",
	  "/api/category/delete") .hasAuthority(UserRole.ROLE_ADMIN.value())
	  
	  // this APIs are only accessible by SELLER
	  .requestMatchers("/api/user/fetch/seller/delivery-person",
	  "/api/user/delete/seller/delivery-person", "/api/product/update/image",
	  ...
	  "/api/order/fetch/user-wise", "/api/cart/update", "/api/cart/add",
	  "/api/cart/fetch", "/api/cart/delete", "/api/product/review/add")
